...
public class GroupBy {
    ...
    public static class Map extends Mapper<LongWritable, Text, Text, DoubleWritable> {
        ...
        public void map(LongWritable key, Text value, Context context)
            ...
            String state    = fields[10];  // State
            String salesStr = fields[17];  // Sales

            try {
                double sales = Double.parseDouble(salesStr);

                // clé composite : Date;State
                outKey.set(date + ";" + state);
                outValue.set(sales);
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "GroupBy_Date_State");
...
/*cat output/groupBy-1764938862/part-r-00000  Q3.1 */